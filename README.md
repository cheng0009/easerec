...
本项目采用 **简录 EaseRec 限免授权协议**（`LICENSE`）——**个人/非商业使用免费，商业使用须购买授权**：

- **免费**：个人学习、创作、非营利使用（含查看 / 修改源代码）。
- **商用收费**：企业、广告、商单、付费课程等商业用途需购买商业授权；应用内付费 Pro 版本包含商用授权。
- 本协议为**源码可见（source-available）**授权，非 OSI 开源许可证。
